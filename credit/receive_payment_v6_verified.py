...
from credit.integrity import assert_credit_integrity
...
def receive_payment():
    ...
    try:
        ...
        # ------------------------------------
        # PRE-PAYMENT INTEGRITY CHECK
        # ------------------------------------
        assert_credit_integrity(conn)
        ...
        # ------------------------------------
        # POST-PAYMENT INTEGRITY CHECK
        # ------------------------------------
        assert_credit_integrity(conn)

        # ------------------------------------
        # COMMIT ONLY AFTER INTEGRITY PASSES
        # ------------------------------------
        conn.commit()
