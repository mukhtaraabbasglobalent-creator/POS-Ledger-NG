...
def get_payment_total(
    ...
    """
    Count only payments that occurred AFTER
    the promise/follow-up was created.

    Payments made before the promise are not
    considered fulfillment of that promise.
    """
